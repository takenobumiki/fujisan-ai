...
const UI_TEXTS = {
  en: {
    ...
    hero_subtitle: 'Instructional Design meets SLA theory and AI-driven personalization. Pass JLPT N5-N1 with a system engineered for results.',
    ...
    feature_lang_desc: 'Interface and AI explanations in 6 languages. Native-language scaffolding accelerates comprehension.',
    // LP - 4 Modes Section
  ...
  'zh-TW': {
    ...
    feature_lang_title: '6種語言支援',
    feature_lang_desc: '介面與AI解說支援6種語言。母語輔助加速理解。',
    modes_label: '系統化學習架構',
    modes_title: '四階段習得框架',
  ...
  'zh-CN': {
    ...
    feature_lang_title: '6种语言支持',
    feature_lang_desc: '界面与AI解说支持6种语言。母语辅助加速理解。',
    modes_label: '系统化学习架构',
    modes_title: '四阶段习得框架',
  ...
  ko: {
    ...
    feature_lang_title: '6개 언어 지원',
    feature_lang_desc: '6개 언어로 인터페이스와 AI 설명 지원. 모국어 지원으로 이해 가속화.',
  ...
  vi: {
    ...
    feature_lang_title: 'Hỗ trợ đa ngôn ngữ', feature_lang_desc: 'Giao diện và giải thích AI bằng 6 ngôn ngữ.',
  ...
  id: {
    ...
    upgrade: 'Upgrade', upgrade_premium: 'Upgrade ke Premium',
    // LP - Bahasa Indonesia
    ...
    hero_cta: 'Mulai Uji Coba Gratis',
    ...
    feature_lang_title: 'Dukungan 6 Bahasa', feature_lang_desc: 'Antarmuka dan penjelasan AI dalam 6 bahasa.',
