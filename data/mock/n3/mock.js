  ...
  "sets": {
    ...
    "3": [
      ...
      },
      {
        ...
        "answer": 3,
        "id": "N3-03-079",
        "script": "会社での会話です。\n女：スケジュールの作成とメンバーを選ぶ、どちらを先にしますか。\n男：スケジュールの作成の方が急ぎですね。\n女：では、そちらからやります。"
      },
      {
        "type": "<ruby>聴解<rt>ちょうかい</rt></ruby>（<ruby>課題理解<rt>かだいりかい</rt></ruby>）",
