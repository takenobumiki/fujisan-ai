  ...
  "sets": {
    "1": [
      ...
      },
      {
        ...
        "answer": 3,
        "id": "N3-01-076",
        "script": "会社での会話です。\n女：スケジュールを立てると目標の設定、どちらを先にしますか。\n男：スケジュールを立てるの方が急ぎですね。\n女：では、そちらからやります。"
      },
      {
        "type": "<ruby>聴解<rt>ちょうかい</rt></ruby>（<ruby>課題理解<rt>かだいりかい</rt></ruby>）",
    ...
    "7": [
      ...
      },
      {
        ...
        "answer": 0,
        "id": "N3-07-080",
        "script": "会社での会話です。\n女：スケジュールを立てるとメンバーを選ぶ、どちらを先にしますか。\n男：スケジュールを立てるの方が急ぎですね。\n女：では、そちらからやります。"
      },
      {
        "type": "<ruby>聴解<rt>ちょうかい</rt></ruby>（<ruby>課題理解<rt>かだいりかい</rt></ruby>）",
